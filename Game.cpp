...
int main(int argc, char* argv[])
{
	...
	SDL_Rect back_rect;
	SDL_Texture* back_tex = loadTextureFromFile("LEVEL3.png", &back_rect, window, renderer, screen_surface);
	...
	Enemy* enemy[100];
	int ZOMBIE_COUNT = 0, SHOOTER_COUNT = 0;
	// Тут читать
	EnemyLoad(enemy, "EnemyLevel3.txt", ZOMBIE_COUNT, SHOOTER_COUNT);
